...
public class MultiSpinnerORG extends Spinner implements OnMultiChoiceClickListener, OnCancelListener {
    ...
    public MultiSpinnerORG(Context context) {
        super(context);
    }

    public MultiSpinnerORG(Context arg0, AttributeSet arg1) {
        super(arg0, arg1);
    ...
    public MultiSpinnerORG(Context arg0, AttributeSet arg1, int arg2) {
